...
/* harmony import */ var _update_network_update_network_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./update-network/update-network.component */ "./src/app/update-network/update-network.component.ts");
/* harmony import */ var _install_update_chaincode_install_update_chaincode_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./install-update-chaincode/install-update-chaincode.component */ "./src/app/install-update-chaincode/install-update-chaincode.component.ts");
...
/* harmony import */ var _custom_explorer_custom_explorer_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./custom-explorer/custom-explorer.component */ "./src/app/custom-explorer/custom-explorer.component.ts");
/* harmony import */ var _custom_swagger_api_custom_swagger_api_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./custom-swagger-api/custom-swagger-api.component */ "./src/app/custom-swagger-api/custom-swagger-api.component.ts");
/* harmony import */ var _docker_container_logs_docker_container_logs_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./docker-container-logs/docker-container-logs.component */ "./src/app/docker-container-logs/docker-container-logs.component.ts");
...
const routes = [
    ...
    { path: 'updatenetwork', component: _update_network_update_network_component__WEBPACK_IMPORTED_MODULE_5__["UpdateNetworkComponent"] },
    { path: 'chaincode', component: _install_update_chaincode_install_update_chaincode_component__WEBPACK_IMPORTED_MODULE_6__["InstallUpdateChaincodeComponent"] },
    { path: 'identities', component: _create_identities_create_identities_component__WEBPACK_IMPORTED_MODULE_7__["CreateIdentitiesComponent"] },
    { path: 'explorer', component: _custom_explorer_custom_explorer_component__WEBPACK_IMPORTED_MODULE_8__["CustomExplorerComponent"] },
    { path: 'swagger', component: _custom_swagger_api_custom_swagger_api_component__WEBPACK_IMPORTED_MODULE_9__["CustomSwaggerApiComponent"] },
    { path: 'docker', component: _docker_container_logs_docker_container_logs_component__WEBPACK_IMPORTED_MODULE_10__["DockerContainerLogsComponent"] }
];
...
/* harmony import */ var _page_tabs_page_tabs_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./page-tabs/page-tabs.component */ "./src/app/page-tabs/page-tabs.component.ts");
/* harmony import */ var _create_identities_create_identities_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./create-identities/create-identities.component */ "./src/app/create-identities/create-identities.component.ts");
/* harmony import */ var _create_update_network_create_update_network_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./create-update-network/create-update-network.component */ "./src/app/create-update-network/create-update-network.component.ts");
/* harmony import */ var _update_network_update_network_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./update-network/update-network.component */ "./src/app/update-network/update-network.component.ts");
/* harmony import */ var _install_update_chaincode_install_update_chaincode_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./install-update-chaincode/install-update-chaincode.component */ "./src/app/install-update-chaincode/install-update-chaincode.component.ts");
/* harmony import */ var _install_prerequisites_install_prerequisites_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./install-prerequisites/install-prerequisites.component */ "./src/app/install-prerequisites/install-prerequisites.component.ts");
/* harmony import */ var _custom_explorer_custom_explorer_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./custom-explorer/custom-explorer.component */ "./src/app/custom-explorer/custom-explorer.component.ts");
/* harmony import */ var _custom_swagger_api_custom_swagger_api_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./custom-swagger-api/custom-swagger-api.component */ "./src/app/custom-swagger-api/custom-swagger-api.component.ts");
/* harmony import */ var _docker_container_logs_docker_container_logs_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./docker-container-logs/docker-container-logs.component */ "./src/app/docker-container-logs/docker-container-logs.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _page_tabs_page_tabs_component__WEBPACK_IMPORTED_MODULE_7__["PageTabsComponent"],
            _create_identities_create_identities_component__WEBPACK_IMPORTED_MODULE_8__["CreateIdentitiesComponent"],
            _create_update_network_create_update_network_component__WEBPACK_IMPORTED_MODULE_9__["CreateUpdateNetworkComponent"],
            _update_network_update_network_component__WEBPACK_IMPORTED_MODULE_10__["UpdateNetworkComponent"],
            _install_update_chaincode_install_update_chaincode_component__WEBPACK_IMPORTED_MODULE_11__["InstallUpdateChaincodeComponent"],
            _install_prerequisites_install_prerequisites_component__WEBPACK_IMPORTED_MODULE_12__["InstallPrerequisitesComponent"],
            _custom_explorer_custom_explorer_component__WEBPACK_IMPORTED_MODULE_13__["CustomExplorerComponent"],
            _custom_swagger_api_custom_swagger_api_component__WEBPACK_IMPORTED_MODULE_14__["CustomSwaggerApiComponent"],
            _docker_container_logs_docker_container_logs_component__WEBPACK_IMPORTED_MODULE_15__["DockerContainerLogsComponent"]
        ],
        imports: [
...
let CreateIdentitiesComponent = class CreateIdentitiesComponent {
    constructor(formBuilder, http, config, modalService) {
    ...
    onClickRegisterAdmin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.http.post('/identities/regAdmin', { payload }).subscribe(data => {
    ...
    onClickRegisterUser() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.http.post('/identities/regUser', { payload }).subscribe(data => {
...
CreateIdentitiesComponent.ctorParameters = () => [
...
let CreateUpdateNetworkComponent = class CreateUpdateNetworkComponent {
    ...
    createCryptoFile() {
        this.httpClient.post('/network/createCryptoFile', this.createNetwork).subscribe((response) => {
    ...
    createConfigFile(network) {
        this.httpClient.post('/network/createConfigFile', network).subscribe((response) => {
            const resp = JSON.parse(JSON.stringify(response));
            console.log(resp);
            if (resp.success) {
                // tslint:disable-next-line: max-line-length
    ...
    generateCertsAndConfigFiles() {
        this.httpClient.get('/network/generateCertsAndConfigFiles').subscribe((response) => {
            const resp = JSON.parse(JSON.stringify(response));
            console.log(resp);
            if (resp.success) {
                // tslint:disable-next-line: max-line-length
    ...
    createDockerFile(network) {
        this.httpClient.post('/network/createDockerFile', network).subscribe((response) => {
            const resp = JSON.parse(JSON.stringify(response));
            if (resp.success) {
                // tslint:disable-next-line: max-line-length
    ...
    startNetwork(network) {
        this.httpClient.post('/network/startNetwork', network).subscribe((response) => {
            const resp = JSON.parse(JSON.stringify(response));
            if (resp.success) {
                // tslint:disable-next-line: max-line-length
...
let InstallUpdateChaincodeComponent = class InstallUpdateChaincodeComponent {
    ...
    generateSwaggerFile() {
        this.http.get('/chaincode/generateSwaggerFile').subscribe((response) => {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JsonViewer", function() { return JsonViewer; });
...
let UpdateNetworkComponent = class UpdateNetworkComponent {
    constructor(formBuilder, http, config, modalService) {
        this.formBuilder = formBuilder;
        this.http = http;
        this.modalService = modalService;
    ...
    createServicesTemplate(domainName, orgName, peerCount) {
        let orgCount = +(orgName.substring(orgName.length - 1));
    ...
    createPeerOrgs(OrdererObjectUserData) {
        ...
        this.http.post('/updatenetwork/CreatePeerOrgs', { peersObject }).subscribe(data => {
    ...
    createNewConfigTx(OrdererObjectUserData) {
        ...
        this.http.post('/updatenetwork/CreateNewConfigTx', { newConfigTx }).subscribe(data => {
            console.log("POST Request is successful ", data);
            jquery__WEBPACK_IMPORTED_MODULE_6__(".modal-body").append('<div class="alert alert-success" role="alert"><strong>Success !!</strong> network configuration files created.</div>');
            // alert(JSON.stringify(data));
        }, error => {
            console.log("Error", error);
            alert(JSON.stringify(error));
    ...
    createDockerCompose(OrdererObjectUserData) {
        ...
        console.log(payload);
        this.http.post('/updatenetwork/peerDockerCompose', { payload }).subscribe(data => {
            console.log("POST Request is successful ", data);
            //$(".modal-body").append('<div class="alert alert-success" role="alert"><strong>Success !!</strong> ' + JSON.stringify(data) + '</div>');
            // alert(JSON.stringify(data));
        }, error => {
    ...
    spinUpContainers(data) {
        ...
        this.http.post('/updatenetwork/spinUp', { channelName }).subscribe(data => {
            console.log("POST Request is successful ", data);
        }, error => {
            console.log("Error", error);
            alert(JSON.stringify(error));
...
UpdateNetworkComponent.ctorParameters = () => [
...
UpdateNetworkComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./update-network.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/update-network/update-network.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./update-network.component.css */ "./src/app/update-network/update-network.component.css")).default]
    })
...
module.exports = __webpack_require__(/*! /home/ubuntu/CustomFramework/src/main.ts */"./src/main.ts");
